...
/*/
//--------------------------------------------------------------------
User Function UPDAST01( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDAST01" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDAST01" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SA1'																	, .T. }, ; //X3_ARQUIVO
	{ 'Z3'																	, .T. }, ; //X3_ORDEM
	{ 'A1_XIDASTR'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'ID Astrein'															, .T. }, ; //X3_TITULO
	{ 'ID Astrein'															, .T. }, ; //X3_TITSPA
	{ 'ID Astrein'															, .T. }, ; //X3_TITENG
	{ 'ID Cliente Astrein'													, .T. }, ; //X3_DESCRIC
	{ 'ID Cliente Astrein'													, .T. }, ; //X3_DESCSPA
	{ 'ID Cliente Astrein'													, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	{ 'ID Astrein'															, .T. }, ; //X3_TITSPA
	{ 'ID Astrein'															, .T. }, ; //X3_TITENG
	{ 'ID Fornece Astrein'													, .T. }, ; //X3_DESCRIC
	{ 'ID Fornece Astrein'													, .T. }, ; //X3_DESCSPA
	{ 'ID Fornece Astrein'													, .T. }, ; //X3_DESCENG
	{ '9999999999'															, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'ID Astrein'															, .T. }, ; //X3_TITSPA
	{ 'ID Astrein'															, .T. }, ; //X3_TITENG
	{ 'ID Produto Astrein'													, .T. }, ; //X3_DESCRIC
	{ 'ID Produto Astrein'													, .T. }, ; //X3_DESCSPA
	{ 'ID Produto Astrein'													, .T. }, ; //X3_DESCENG
	{ '9999999999'															, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX6, { ;
	...
	'BZ_ARQASTR'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Nome que sera salvo o arquivo contendo o Token uti'					, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	"lizado nas API's de integracao Astrein."								, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'astrein_token'															, ; //X6_CONTEUD
	'astrein_token'															, ; //X6_CONTSPA
	'astrein_token'															, ; //X6_CONTENG
	'U'																		, ; //X6_PROPRI
	''																		, ; //X6_VALID
	''																		, ; //X6_INIT
	''																		, ; //X6_DEFPOR
...
aAdd( aSX6, { ;
	...
	'BZ_DIRASTR'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Define diretorio onde sera salvo arquivo Token uti'					, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'lizado nas interacoes Astrein.'										, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
...
aAdd( aSX6, { ;
	...
	'BZ_EMPASTR'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Nome da empresa para realizar consulta dos dados n'					, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'a Astrein (BEPI,LABOR,CHS)'											, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
...
aAdd( aSX6, { ;
	...
	'BZ_PASASTR'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	"Senha utilizado nas API's de integracao da Astrein"					, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
...
aAdd( aSX6, { ;
	...
	'BZ_TPIASTR'															, ; //X6_VAR
	'N'																		, ; //X6_TIPO
	'Codigo do projeto que realiza as integracoes Astre'					, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'in'																	, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
...
aAdd( aSX6, { ;
	...
	'BZ_URLASTR'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	"URL para acesso as API's da Astrein"									, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	...
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'https://api.astrein.com.br/bunzldev/api'								, ; //X6_CONTEUD
	'https://api.astrein.com.br/bunzldev/api'								, ; //X6_CONTSPA
	'https://api.astrein.com.br/bunzldev/api'								, ; //X6_CONTENG
	'U'																		, ; //X6_PROPRI
	''																		, ; //X6_VALID
	''																		, ; //X6_INIT
	''																		, ; //X6_DEFPOR
...
aAdd( aSX6, { ;
	...
	'BZ_USRASTR'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	"Usuario utilizado nas API's de integracao Astrein"						, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDAST01" ) ) ) ;
