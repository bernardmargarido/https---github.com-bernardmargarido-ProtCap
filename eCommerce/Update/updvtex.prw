...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgInfo( "Atualização realizada.", "UPDVTEX" )
				Else
...
aAdd( aSX2, { ;
	...
	'Especificaçoes'														, ; //X2_NOME
	'Especificaçoes'														, ; //X2_NOMESPA
	'Especificaçoes'														, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'Valores das Especificações'											, ; //X2_NOME
	'Valores das Especificações'											, ; //X2_NOMESPA
	'Valores das Especificações'											, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'Produtos x Especificações'												, ; //X2_NOME
	'Produtos x Especificações'												, ; //X2_NOMESPA
	'Produtos x Especificações'												, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'Amarração filiais protheus x v'										, ; //X2_NOME
	'Amarração filiais protheus x v'										, ; //X2_NOMESPA
	'Amarração filiais protheus x v'										, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nº Orcamento'															, ; //X3_TITULO
	'Nº Orcamento'															, ; //X3_TITSPA
	'Nº Orcamento'															, ; //X3_TITENG
...
aAdd( aSX3, { ;
	...
	'Decrição'																, ; //X3_TITSPA
	'Decrição'																, ; //X3_TITENG
	'Descrição pagamento'													, ; //X3_DESCRIC
	'Descrição pagamento'													, ; //X3_DESCSPA
	'Descrição pagamento'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	'Dias Expiração'														, ; //X3_DESCRIC
	'Dias Expiração'														, ; //X3_DESCSPA
	'Dias Expiração'														, ; //X3_DESCENG
	'99999'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Obrigatório?'															, ; //X3_TITULO
	'Obrigatório?'															, ; //X3_TITSPA
	'Obrigatório?'															, ; //X3_TITENG
	'Obrigatório?'															, ; //X3_DESCRIC
	'Obrigatório?'															, ; //X3_DESCSPA
	'Obrigatório?'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	'€'																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=Text;2=Multi Line Text;4=Número;5=Combo;6=Radio;7=CheckBox;8=Indexed Text;9=Indexed Multi-Line Text', ; //X3_CBOX
	'1=Text;2=Multi Line Text;4=Número;5=Combo;6=Radio;7=CheckBox;8=Indexed Text;9=Indexed Multi-Line Text', ; //X3_CBOXSPA
	'1=Text;2=Multi Line Text;4=Número;5=Combo;6=Radio;7=CheckBox;8=Indexed Text;9=Indexed Multi-Line Text', ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	'Grupo Esp'																, ; //X3_TITSPA
	'Grupo Esp'																, ; //X3_TITENG
	'Grupo Especificação'													, ; //X3_DESCRIC
	'Grupo Especificação'													, ; //X3_DESCSPA
	'Grupo Especificação'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	'Descriçao'																, ; //X3_TITSPA
	'Descriçao'																, ; //X3_TITENG
	'Descriçao'																, ; //X3_DESCRIC
	'Descriçao'																, ; //X3_DESCSPA
	'Descriçao'																, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSIX, { ;
	...
	'Codigo+Decrição'														, ; //DESCRICAO
	'Codigo+Decrição'														, ; //DESCSPA
	'Codigo+Decrição'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	...
	'Produto + Especificaçao'												, ; //DESCRICAO
	'Produto + Especificaçao'												, ; //DESCSPA
	'Produto + Especificaçao'												, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	...
	'Codigo ERP+Descrição'													, ; //DESCRICAO
	'Codigo ERP+Descrição'													, ; //DESCSPA
	'Codigo ERP+Descrição'													, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSX6, { ;
	...
	'EC_APPVTEX'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Define App Key para atutenticação VTEX'								, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
...
aAdd( aSX6, { ;
	...
	'EC_CPOESP'																, ; //X6_VAR
	'L'																		, ; //X6_TIPO
	'Define se será integrado campos especificos dos pr'					, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
...
aAdd( aSX6, { ;
	...
	'EC_TABECO'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Tabela de preços padrao eCommerce'										, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
...
aAdd( aSX6, { ;
	...
	'EC_TESECO'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Tes padrao para vendas eCommerce caso não utilizad'					, ; //X6_DESCRIC
...
aAdd( aSX6, { ;
	...
	'EC_URLVTEX'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Endpoint de integração Protheus X VTEX'								, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Especificaçoes'														, ; //XB_DESCRI
	'Especificaçoes'														, ; //XB_DESCSPA
	'Especificaçoes'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZTE'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'01'																	, ; //XB_COLUNA
	'Codigo Erp+descrição'													, ; //XB_DESCRI
	'Codigo Erp+descrição'													, ; //XB_DESCSPA
	'Codigo Erp+descrição'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	''																		} ) //XB_CONTEM
